...
if __name__ == "__main__":
    cys1 = StructMotifResidue(
        struct_oper_id="1",
        chain_id="A",
        label_seq_id=100
    )
    cys2 = StructMotifResidue(
        struct_oper_id="1",
        chain_id="A",
        label_seq_id=103
    )
    his3 = StructMotifResidue(
        struct_oper_id="1",
        chain_id="A",
        label_seq_id=115
    )
    cys4 = StructMotifResidue(
        struct_oper_id="1",
        chain_id="A",
        label_seq_id=119
    )
    ...
    # Write CSV
    with open("/Users/yana.rose/C2HC-zinc-binding-proteins.csv", "w") as handle:
